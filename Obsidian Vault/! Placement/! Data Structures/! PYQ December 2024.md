...
*   **Core Concept: Binary Heap (Max-Heap)**
    ...
    *   **Deleting the maximum:**
        ...
        3.  The heap property might be violated, so the new root is "sifted down" (heapified down) by swapping it with its largest child until the heap property is restored. This sift-down operation takes O(log n) time because the height of a heap with n elements is log n.
*   **Related Concepts/Similar Questions:**
