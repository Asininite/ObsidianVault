...
## [Listening to events](https://nextjs.org/learn/react-foundations/updating-state#listening-to-events)
...
## [Handling events](https://nextjs.org/learn/react-foundations/updating-state#handling-events)
...
![Two different examples of state: 1. A toggle button that can be selected or unselected. 2. A like button that can be clicked multiple times.](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flearn-state.png&w=3840&q=75)
...
![[Pasted image 20250804173551.png]]
