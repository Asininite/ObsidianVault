...
- [ ] **Primitive Data types**
    - [ ] Integers, Floating Point Types, Characters, Boolean
    - [ ] Literals
...
- [ ] **Object Oriented Programming in Java**
    ...
    - [ ] Recursion
    - [ ] Access Control
    - [ ] Static Members & Final Variables
    - [ ] Inner Classes
    - [ ] Command Line Arguments & Variable Length Arguments
- [ ] **Inheritance**
    - [ ] Super Class, Sub Class, The Keyword `super`
    - [ ] `protected` Members
...
- [ ] **Java Library - String Handling**
    - [ ] String Constructors, String Length
    - [ ] Special String Operations (Character Extraction, Comparison, Searching, Modifying)
    - [ ] `valueOf()` method
    - [ ] Comparison of `StringBuffer` and `String`
- [ ] **Collections framework**
    - [ ] Collections overview
    - [ ] Collections Interfaces (Collection, List)
...
- [ ] **Multithreaded Programming**
    - [ ] The Java Thread Model & The Main Thread
...
- [ ] **Swings fundamentals**
    ...
    - [ ] Swing Controls, Components, and Containers
    - [ ] Swing Packages
